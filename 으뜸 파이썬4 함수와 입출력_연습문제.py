...
# #4.16
# s=list(map(int,input('쉼표로구분된 정수를 여러 개 입력하시오 : ').split(',')))
# new_s=sorted(s)
# print(f'입력된 정수리스트{s}')
# print(f'정렬된 정수리스트{new_s}')
# #4.17
# def sum_range(n1,n2):
...
if len(str(d))==1:
  newd='0'+str(d)
print(f'주민번호 앞자리는{str(y)[2:]}{newm}{newd}')
#4.23
...
for i in n:
   ...
   if i[city_start_num:city_end_num]=='Bython':
       ...
       change_count+=1
print(f'수정된 문자열{n} 모두 {change_count}수정했습니다')
#4.27
